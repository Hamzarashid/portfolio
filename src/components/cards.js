...
const Card = (props) => {
  return (
    <div className=" bg-gray-100 dark:bg-gray-900 rounded-xl shadow-xl m-6 xl:m-0 h-full hover:scale-110 cursor-pointer transition duration-500 ">
      <div className="">
        <div className="p-8 ">
          <div className="inline-flex">
            <img alt="" src={props.logo} width={props.width} />
            {props.logo2 && (
              <img alt="" src={props.logo2} width={props.width} />
            )}
          </div>
